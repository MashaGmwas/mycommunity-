...
const CreateSocietyModal = ({ isOpen, onClose, onSocietyCreated }) => {
...
        try {
            const response = await fetch('http://localhost:5000/api/societies/createsociety', {
                method: 'POST',
                body: formData,
            });
...
            onSocietyCreated(result.society);
            onClose();
